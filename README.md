...
Intelligent Services is a framework for building AI-assisted operational systems that can understand business documentation, project lifecycles, SOPs, governance requirements, and compliance constraints.

## Current Focus

The first rule pack establishes a data governance and compliance foundation for agents that need to reason across:
...
The repository now includes a baseline rule system for operational governance and regulatory awareness.
...
Agents should not simply summarize documents. They should evaluate whether a workflow is governed, traceable, and audit-ready.
